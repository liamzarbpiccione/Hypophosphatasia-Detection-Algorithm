<<<<<<< HEAD
"""
HPP Detection Algorithm

This script processes Excel files to detect potential Hypophosphatasia (HPP) cases
based on user-defined filters for ALP, Phosphate, eGFR, and MRN entry counts.
It uses a GUI for file selection and filter configuration, then outputs filtered
results to a new Excel file on the Desktop.

Requirements: pandas, tkinter, openpyxl (for Excel handling)
"""
...
# File Selection: Allow user to select Excel files or a folder containing them
if __name__ == "__main__":
    try:
        ...
        # GUI for Filter Settings: Display a window to configure filters
        def show_filter_settings_window():
            """
            Display a GUI window for the user to configure filter settings.
            ...
            # Build the GUI layout for filter settings
            row = 0
            ...
            # MRN minimum entries filter controls
            ...
            # ALP upper limit filter controls
            ...
            # Conditional Phosphate filter controls
...
if __name__ == "__main__":
    try:
        ...
        try:
            ...
            pass
        sys.exit(1)
>>>>>>> 7857b58 (ready to use executable file)
